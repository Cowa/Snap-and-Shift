...
function Leaf:initialize(world, x, y, w, h)
  ...
  local img = cache:getOrLoadImage("asset/leaf.png")
  self.leafParticle = love.graphics.newParticleSystem(img, 5)
  self.leafParticle:setParticleLifetime(5)
  self.leafParticle:setEmissionRate(2)
  self.leafParticle:setPosition(w / 2, 0)
  self.leafParticle:setAreaSpread("uniform", w / 2, 0)
